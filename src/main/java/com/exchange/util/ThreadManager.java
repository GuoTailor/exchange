...
public class ThreadManager {
    ...
    private static final class InstanceHolder {
        static final ThreadManager workPool = new ThreadManager(new SynchronousQueue<>());
        static final ThreadManager quickPool = new ThreadManager(poolSize * 2, new LinkedBlockingQueue<>(1024));
    }
